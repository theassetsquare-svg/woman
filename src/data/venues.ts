...
const seoDescriptions: Record<string, string> = {
  ...
  'busan-mulnight': '부산 연산동 대표 나이트클럽 물나이트입니다. 따봉 실장이 직접 운영하며 최고의 사운드와 조명으로 열기 넘치는 밤을 선사합니다. 전화 예약 후 방문하세요',
  'seongnam-shampoo': '성남 대표 샴푸나이트입니다. 박찬호 실장이 직접 운영하며 세련된 분위기와 다양한 이벤트로 잊지 못할 밤을 만들어 드립니다. 사전 문의 후 방문 권장',
  'suwon-chancedom': '수원 대표 찬스돔나이트입니다. 강호동 실장이 직접 운영하며 대형 돔 구조에서 펼쳐지는 화려한 파티를 즐길 수 있습니다. 전화 예약 후 방문하세요',
  'seoul-suyu-shampoo': '수유 대표 샴푸나이트입니다. 강북 지역 최고의 사운드 시설과 넓은 공간에서 신나는 밤을 보낼 수 있습니다. 사전 문의 후 방문 권장',
  'seoul-sinlim-grandprix': '신림 대표 그랑프리나이트입니다. 태양 실장이 직접 운영하며 관악구 최대 규모 나이트클럽에서 열정적인 밤을 경험할 수 있습니다. 전화 예약 후 방문하세요',
  'gangnam-h2o': '청담 대표 H2O나이트입니다. 펩시맨 실장이 직접 운영하며 강남권 최고급 사운드와 VIP 서비스를 제공합니다. 사전 예약 필수',
  'indeogwon-gukbingwan': '인덕원 대표 국빈관나이트입니다. 격조 있는 분위기 속에서 최상의 나이트 경험을 제공하는 안양 지역 대표 업소입니다. 사전 문의 후 방문 권장',
  'paju-skydome': '파주 야당 대표 스카이돔나이트입니다. 막내 실장이 직접 운영하며 돔 형태의 독특한 공간에서 특별한 밤을 즐길 수 있습니다. 전화 예약 후 방문하세요',
  'ulsan-champion': '울산 대표 챔피언나이트입니다. 춘자 실장이 직접 운영하며 울산 최대 규모 나이트클럽에서 최고의 밤을 경험할 수 있습니다. 전화 예약 후 방문하세요',
  'ilsan-shampoo': '일산 대표 샴푸나이트입니다. 고양시 최대 규모 나이트클럽으로 넓은 공간과 최신 사운드 시설을 갖추고 있습니다. 사전 문의 후 방문 권장',
  'incheon-arabian': '인천 대표 아라비안나이트입니다. 라이타 실장이 직접 운영하며 이국적 인테리어와 최고의 사운드로 특별한 밤을 선사합니다. 전화 예약 후 방문하세요',
  'daejeon-seven': '대전 대표 세븐나이트입니다. 충청권 최고의 나이트클럽으로 최신 사운드와 조명 시설을 갖추고 있습니다. 사전 문의 후 방문 권장',
  'seoul-sangbong-hankukgwan': '상봉동 대표 한국관나이트입니다. 서울 동북권 최고의 전통 나이트클럽으로 오랜 역사와 단골 손님을 자랑합니다. 사전 문의 후 방문 권장',
  'gangnam-club-race': '강남 대표 클럽 레이스입니다. 최신 EDM과 화려한 무대 연출로 강남 클럽씬의 정점을 경험할 수 있습니다. 사전 예약 권장',
  'gangnam-club-sound': '강남 대표 클럽 사운드입니다. 프리미엄 음향 시스템과 세련된 공간에서 최고의 클러빙을 즐길 수 있습니다. 사전 예약 권장',
  'itaewon-waikiki': '이태원 대표 클럽 와이키키유토피아입니다. 글로벌 감성과 다양한 문화가 어우러진 특별한 파티를 경험할 수 있습니다. 사전 예약 권장',
  'gangnam-lounge-hype': '강남 대표 라운지 하입입니다. 세련된 인테리어와 프리미엄 서비스로 특별한 밤을 보낼 수 있습니다. 사전 예약 필수',
  'gangnam-lounge-color': '강남 대표 라운지 컬러입니다. 감각적 조명과 트렌디한 분위기로 세련된 밤을 즐길 수 있습니다. 사전 예약 필수',
  'gangnam-lounge-arju': '강남 대표 라운지 아르쥬입니다. 고급스러운 공간에서 여유롭게 즐기는 프리미엄 라운지 경험을 제공합니다. 사전 예약 필수',
};
