...
const seoHooks: Record<string, string> = {
  'busan-mulnight': '연산동 따봉 실장이 직접 관리하는 현장 검증 나이트',
  'seongnam-shampoo': '박찬호 실장 직영, 매주 다른 이벤트로 채우는 밤',
  'suwon-chancedom': '수원 유일 돔 구조, 강호동 실장이 만드는 파티',
  'seoul-sinlim-grandprix': '신림역 5분, 태양 실장이 이끄는 관악 최대 무대',
  'gangnam-h2o': '청담 VIP 동선 설계, 펩시맨 실장의 프리미엄 나이트',
  'paju-skydome': '경기 북부 유일 돔형, 막내 실장이 지키는 야당의 밤',
  'ulsan-champion': '울산 현지인 10명 중 9명 추천, 춘자 실장 10년 직영',
  'seoul-suyu-shampoo': '수유역 인근 강북 최강 사운드, 평일도 빈자리 없는 곳',
  'indeogwon-gukbingwan': '인덕원역 도보권, 격조와 접근성을 동시에 갖춘 나이트',
  'ilsan-shampoo': '고양시 최대 플로어, 경기 서북부 원정객이 모이는 곳',
  'incheon-arabian': '인천 남동구, 이국적 콘셉트로 현실과 분리되는 밤',
  'daejeon-seven': '충청권 전역에서 모이는 대전 대표, 사운드에 이유가 있다',
  'seoul-sangbong-hankukgwan': '상봉역 전통 명소, 세대를 넘어 이어지는 단골 신뢰',
  'gangnam-club-race': '강남 금요밤 입장줄 50m, 몸이 먼저 반응하는 EDM',
  'gangnam-club-sound': '독일제 스피커 시스템, 이름값 하는 강남 음향 클럽',
  'itaewon-waikiki': '이태원 글로벌 파티, 음악이 언어를 대신하는 공간',
  'gangnam-lounge-hype': '신사동, 소파석에서 DJ 셋을 감상하는 새로운 방식',
  'gangnam-lounge-color': '압구정, 9시와 12시의 분위기가 완전히 다른 라운지',
  'gangnam-lounge-arju': '청담 입장 기준이 곧 품질 보증, 예약 필수 프리미엄',
};
...
const seoDescriptions: Record<string, string> = {
  ...
  'seoul-sinlim-grandprix': '신림그랑프리나이트는 태양 실장이 총괄하는 관악구 최대 규모 나이트입니다. 신림역에서 도보 5분 거리에 위치하며, 금요일 밤이면 신림 일대가 모이는 핵심 거점입니다.',
  'gangnam-h2o': '청담H2O나이트는 펩시맨 실장이 이끄는 강남권 최고급 나이트클럽입니다. VIP 전용 동선과 프리미엄 사운드 시스템을 갖추고 있으며, 사전 예약이 필수입니다.',
  'paju-skydome': '파주야당스카이돔나이트는 막내 실장이 운영하는 경기 북부 유일 돔형 나이트입니다. 야당역 인근에 위치하며, 일산·김포에서도 원정 방문객이 많은 핵심 거점입니다.',
  'ulsan-champion': '울산챔피언나이트는 춘자 실장이 10년 넘게 지켜온 울산 대표 나이트클럽입니다. 현지인 추천율이 압도적이며, 울산에서 나이트를 찾는다면 첫 번째 선택지입니다.',
  'seoul-suyu-shampoo': '수유샴푸나이트는 수유역 인근에 위치한 강북 지역 대표 나이트입니다. 강북에서 찾기 어려운 수준의 사운드 시스템을 갖추고 있으며, 평일에도 빈자리가 드문 인기 명소입니다.',
  'indeogwon-gukbingwan': '인덕원국빈관나이트는 인덕원역 도보권에 위치한 안양 지역 대표 나이트입니다. 격조 있는 인테리어와 안양·의왕·과천에서의 뛰어난 접근성이 강점입니다.',
  'ilsan-shampoo': '일산샴푸나이트는 고양시 일산에 위치한 경기 서북부 대표 나이트입니다. 가장 넓은 플로어와 최신 음향 장비를 갖추고 있어 파주·김포에서도 원정 방문객이 많습니다.',
  'incheon-arabian': '인천아라비안나이트는 인천 남동구에 위치한 이국적 콘셉트 나이트클럽입니다. 아라비안 테마 인테리어가 현실과 분리되는 독특한 경험을 선사하며, 인천에서 분위기로 승부하는 유일한 곳입니다.',
  'daejeon-seven': '대전세븐나이트는 대전 서구 중심에 위치한 충청권 대표 나이트클럽입니다. 세종·천안·청주에서도 원정 방문하는 곳으로, 강력한 사운드와 안정된 운영이 강점입니다.',
