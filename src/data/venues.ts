...
export const venues: Venue[] = [
  ...
  },
  {
    ...
    description: '강남 1등 호빠 무한초이스 시스템. 다양한 선수진과 자유로운 초이스로 인기.',
    hours: 'PM 9:00 ~ AM 5:00',
    phone: '별도문의',
    tags: ['강남', '무한초이스', '인기'],
  ...
  // ===== 장안동 =====
  {
    ...
    description: '장안동 10년 베테랑 실장 운영. 서울 동북권에서 가장 검증된 호빠입니다.',
    hours: 'PM 9:00 ~ AM 5:00',
    phone: '별도문의',
    tags: ['장안동', '동대문', '베테랑'],
  ...
  },
  {
    ...
    description: '해운대 No.1 여성전용 토킹 이벤트바. 부담 없이 즐길 수 있습니다.',
    hours: 'PM 9:00 ~ AM 5:00',
    phone: '별도문의',
    tags: ['해운대', '이벤트바', '여성전용'],
  ...
  },
  {
    ...
    description: '광안리 독점 호빠. 선수 40명 항시 대기로 인기입니다.',
    hours: 'PM 9:00 ~ AM 5:00',
    phone: '010-5557-8179',
  ...
  },
  {
    ...
    description: '부담 없이 즐길 수 있는 부산 호빠. 무한 음료 옵션을 제공합니다.',
    hours: 'PM 9:00 ~ AM 5:00',
    phone: '별도문의',
    tags: ['연제구', '부담없는', '무한음료'],
  ...
  },
  {
    ...
    description: '화려한 분위기의 인계동 호빠. 부담 없이 즐길 수 있습니다.',
  ...
  // ===== 창원 =====
  {
    ...
    description: '창원 1등 호빠. 부담 없는 1인 TC 시스템으로 편하게 즐길 수 있습니다.',
    hours: 'PM 9:00 ~ AM 5:00',
    phone: '별도문의',
