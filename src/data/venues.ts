...
const seoHooks: Record<string, string> = {
  'gangnam-boston': '첫 방문이라면 여기부터, 12년간 실패 없는 선택',
  'gangnam-i': '한 번 다녀오면 단골 확정, 재방문율 업계 1위의 비밀',
  'gangnam-flirting': '내 손으로 고른다, 무한초이스의 원조',
  'gangnam-blackhole': '어게인 DNA 계승, 올해 가장 핫한 신상',
  'geondae-wclub': '10년 생존엔 비결이 있다',
  'jangan-bini': '베테랑이 만드는 분위기',
  'jangan-cube': '100명 중 뽑는 재미, 눈치 없이 무한초이스',
  'jangan-bbangbbang': '긴장된다면 딱 맞는 곳, 편안함의 정석',
  'busan-michelin': '서울에서 일부러 내려오는 이유, 에이스 TOP 5 집결',
  'busan-q': '해변 도보 2분, 파도 소리와 함께하는 밤',
  'busan-david': '입문자 필수 코스, 첫 경험은 이곳',
  'busan-aura': '30명 상시 대기, 스케일이 남다른 곳',
  'busan-menz': '광안리 바다 앞 40명, 못 픽하는 게 더 어렵다',
  'busan-w': '오래 살아남은 데는 실력이 증거, 부산 최장수',
  'busan-theking': '무한 음료 포함, 부산에서 제일 가벼운 밤',
  'busan-js': '독립 분리형 룸 완비, 마주칠 염려 제로',
  'busan-michelin-jisung': '내 스타일 정확히 읽는 실장이 있는 곳',
  'suwon-beast': '새벽 8시 논스톱, 12시간 풀가동',
  'suwon-maid': '들어가는 순간 압도당한다, 신축 최대 규모',
  'suwon-play': '노래방+호빠 한 번에, 오전 11시까지',
  'suwon-lasvegas': '가볍게 화려하게, 인계동의 정답',
  'daejeon-eclipse': '대전 독보적 1위, 충청권 원정 맛집',
  'daejeon-tombar': '봉명동 대학가 감성, 젊은 에너지가 넘치는 밤',
  'gwangju-w': '호남권 유일, 이 한 곳만 기억하세요',
  'changwon-avengers': '1인 전담 TC 시스템, 혼자 와도 편하게 즐기는 밤',
};
