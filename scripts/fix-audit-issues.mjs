...
// busan-menz (카톡 besta12)
replace(
  `'전화번호 카톡 besta12로 예약 가능합니다.',`,
  `'전화로 예약 가능합니다.',`
);
replace(
  `맨즈를 방문할 때는 카톡 besta12로 전화하면 예약과 안내를 받을 수 있으며`,
  `맨즈를 방문할 때는 전화하면 예약과 안내를 받을 수 있으며`
);
replace(
  `전화 예약(카톡 besta12), 대리운전`,
  `전화 예약, 대리운전`
);
replace(
  `정확한 비용은 맨즈(카톡 besta12)에 직접 확인하세요.`,
  `정확한 비용은 맨즈에 직접 전화로 확인하세요.`
);
replace(
  `'네, 카톡 besta12로 예약과 문의가 가능합니다.'`,
  `'네, 전화로 예약과 문의가 가능합니다.'`
);
replace(
  `카톡 besta12로 전화 한 통이면 여기의 밤이 시작됩니다.`,
  `전화 한 통이면 여기의 밤이 시작됩니다.`
);

// suwon-beast (카톡 besta12)
replace(
  `'전화번호 카톡 besta12으로 예약 가능합니다.',`,
  `'전화로 예약 가능합니다.',`
);
replace(
  `카톡 besta12으로 전화하면 예약과 안내가 가능합니다.`,
  `전화하면 예약과 안내가 가능합니다.`
);
replace(
  `비스트(카톡 besta12)에 직접 확인하세요.`,
  `비스트에 직접 전화로 확인하세요.`
);
replace(
  `카톡 besta12으로 연락하세요.`,
...
replace(
  `카톡 besta12으로 전화해 여기의 밤을 시작하세요.`,
  `전화 한 통으로 여기의 밤을 시작하세요.`
);

// daejeon-tombar (카톡 besta12)
replace(
  `'가격은 별도 문의이며, 전화번호 카톡 besta12로 예약 가능합니다.',`,
  `'가격은 별도 문의이며, 전화로 예약 가능합니다.',`
);
replace(
  `톰바를 방문하기 전 카톡 besta12로 전화하면`,
  `톰바를 방문하기 전 전화하면`
);
replace(
  `카톡 besta12로 전화하면 그날의 가격과`,
  `전화하면 그날의 가격과`
);
replace(
  `카톡 besta12로 연락하세요.`,
...
replace(
  `카톡 besta12로 반드시 확인하세요.`,
  `전화로 반드시 확인하세요.`
);
replace(
  `전화(카톡 besta12)로 문의하면`,
  `전화로 문의하면`
);
replace(
  `카톡 besta12로 전화해서 여기의 밤을 시작하세요.`,
  `전화 한 통으로 여기의 밤을 시작하세요.`
);
