    ...
    <div>
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 py-6">
        <div className="grid md:grid-cols-2 gap-4">
          {[
            ...
            { title: '요일별 꿀타임이 다릅니다', desc: '월~목 밤 10시 = 선수 선택권 넓음, 금토 밤 9시 = 분위기 절정. 일요일은 쉬는 곳이 많으니 반드시 전화 확인 후 방문하세요.' },
            { title: '강남 vs 장안동 vs 해운대', desc: '강남 = 검증된 선수 + 세련된 분위기, 장안동 = 프라이빗 룸 + 편안함, 해운대 = 관광지 분위기 + 파티형. 취향에 따라 지역부터 정하세요.' },
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 py-10">
        <div className="hooking-dark p-8 md:p-10">
          ...
          <div className="space-y-3">
            {[
              { area: '강남', tag: '하이엔드', desc: '업계 검증된 선수진과 세련된 인테리어. 특별한 날, 완성도 높은 경험을 원한다면 강남이 정답입니다.', color: 'text-purple-400' },
