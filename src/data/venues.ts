...
const seoHooks: Record<string, string> = {
  'gangnam-boston': '12년 무사고, 첫 방문 정답은 여기',
  'gangnam-i': '재방문율 1위, 17년 검증된 하이엔드',
  'gangnam-flirting': '무한초이스 원조, 내 손으로 직접 고른다',
  'gangnam-blackhole': '어게인 DNA 계승, 올해 가장 핫한 신생',
  'geondae-wclub': '10년 생존 비결, 20대 직장인이 몰리는 이유',
  'jangan-bini': '10년 베테랑 실장 직접 운영, 동북권 1위',
  'jangan-cube': '100명 중 고르는 쾌감, 무한초이스 본좌',
  'jangan-bbangbbang': '긴장 제로, 처음이라면 여기가 정답',
  'busan-michelin': '에이스 TOP 5 집결, 서울서 원정 오는 곳',
  'busan-q': '해변 2분 거리, 파도 소리와 시작되는 밤',
  'busan-david': '입문 필수 코스, 부담 제로 원조',
  'busan-aura': '선수 30명 상시 대기, 최대 규모 초이스',
  'busan-menz': '광안리 바다 앞 40명, 못 고르는 게 더 어렵다',
  'busan-w': '최장수 운영 기록, 오래 살아남은 이유',
  'busan-theking': '무한 음료 포함, 가장 부담 없는 선택',
  'busan-js': '프라이빗 룸 완비, 마주칠 걱정 제로',
  'busan-michelin-jisung': '내 취향 정확히 읽는 맞춤 배정',
  'suwon-beast': '새벽 8시까지 논스톱, 12시간 풀가동',
  'suwon-maid': '들어가면 압도당한다, 신축 최대 규모',
  'suwon-play': '노래방 결합 끝판왕, 오전 11시까지',
  'suwon-lasvegas': '화려한 조명 아래, 인계동의 부담 없는 정답',
  'daejeon-eclipse': '경쟁자 없는 독보적 1위, 충청권 원정 맛집',
  'daejeon-tombar': '봉명동 대학가 감성, 젊은 에너지가 다르다',
  'gwangju-w': '호남권 유일 선택지, 이 한 곳만 기억하세요',
  'changwon-avengers': '1인 전담 TC 시스템, 혼자 와도 편하게',
};
