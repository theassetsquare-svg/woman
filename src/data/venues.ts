...
const seoHooks: Record<string, string> = {
  'seoul-boston': '12년 전통이 증명한 퀄리티',
  'seoul-i': '재방문율 업계 1위, 아는 사람만 오는 곳',
  'seoul-flirting': '무한초이스 시스템의 원조',
  'seoul-wclub': '건대 10년 생존, 이유 있는 선택',
  'seoul-123': '종로 콜 1위, 대화에 집중하는 밤',
  'seoul-372': '홍대 유일 컨셉, 20대 감성 특화',
  'seoul-blackhole': '어게인 DNA를 물려받은 신생 프리미엄',
  'seoul-bini': '장안동 10년 베테랑이 직접 운영',
