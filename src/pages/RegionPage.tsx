...
export default function RegionPage() {
  ...
  const regionHook: Record<string, { title: string; desc: string }> = {
    gangnam: {
      ...
      desc: '역삼·테헤란로 검증된 4곳, 선수 수준·초이스 방식·영업시간 낱낱이 비교해드립니다',
    },
    geondae: {
      title: '건대호빠 — 단골이 입 다무는 검증된 1곳',
      desc: '건대입구역 도보권, 10년 생존한 이유를 선수·분위기·시스템으로 직접 확인하세요',
    },
    jangan: {
      title: '장안동호빠 TOP 3 — 프라이빗 끝판왕 대결',
      desc: '동대문구 검증 완료 3곳, 룸 구조·선수진·초이스 횟수까지 전격 해부합니다',
    },
    busan: {
      title: '부산호빠 TOP 10 — 해운대부터 하단까지 총정리',
      desc: '해운대·광안리·연산동·수영구 10곳 전수 조사, 에이스 선수 어디 있는지 낱낱이 공개',
    },
    gyeonggi: {
      title: '수원호빠 TOP 4 — 인계동 서울급 반전 매력',
      desc: '검증된 4곳, 새벽 8시까지 논스톱 영업부터 신축 시설까지 현장 확인 완료',
    },
    daejeon: {
      title: '대전호빠 TOP 2 — 현지인만 아는 숨은 핫플',
      desc: '둔산동·봉명동 검증 완료 2곳, 충청권 대표 선수·분위기·시스템 밀착 취재 결과 공개',
    },
    gwangju: {
      title: '광주호빠 — 호남권 유일무이 이 한 곳이면 끝',
      desc: '상무지구 검증 완료, 다른 곳 알아볼 필요 없는 이유를 직접 확인하세요',
    },
    changwon: {
      title: '창원호빠 — 경남 대표 반드시 가봐야 할 곳',
      desc: '상남동 검증 완료, 1인 전담 시스템으로 혼자 가도 걱정 없는 유일 업소 현장 리포트',
    },
  };
