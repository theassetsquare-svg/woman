...
const catConfig: Record<CatKey, { label: string; plural: string; title: string; desc: string; intro: string }> = {
  ...
  yojeong: {
    ...
    intro: `한국 전통 문화를 경험하는 특별한 공간입니다. 15가지 이상의 한정식에 국악 라이브, 단아한 한복 서비스. 격조 있는 분위기에서 접대하거나 비즈니스 모임을 진행하기에 이만한 곳이 없습니다.\n\n수십 개의 프라이빗 개인실이 있어 인원과 목적에 맞게 선택할 수 있습니다. 정찰제로 운영되어 추가 비용 걱정이 없다는 것도 장점입니다.\n\n특별한 날, 격이 다른 자리가 필요할 때. 여기서 미리 확인하세요.`,
  },
  hoppa: {
    label: '호빠',
    plural: 'hoppa',
